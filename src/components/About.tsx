...
const About = () => {
  ...
  return <section id="about" className="py-20 px-6 border-t-4 border-border/30">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">As a game analyst, I've worked on Jump Rope (which peaked at 20k CCU, has 45M visits, and generated over 3M Robux) where I made significant improvements by analyzing player statistics and behavior patterns. I've also collaborated with multiple YouTubers totaling over 100k subscribers.</p>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {highlights.slice(0, 3).map((highlight, index) => <Card key={highlight.title} className="p-6 bg-gradient-card border-border/50 hover:shadow-glow transition-all duration-300 hover:scale-105">
            ...
            <Card className="p-6 bg-gradient-card border-border/50 hover:shadow-glow transition-all duration-300 hover:scale-105 sm:col-span-2">
              <Zap className="h-8 w-8 text-primary mb-3" />
